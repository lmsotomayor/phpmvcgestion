...
$fechaDesdeComision = $_GET['fechaDesdeComision'];
$fechaHastaComision = $_GET['fechaHastaComision'];
...
$pdf->Cell(50, 8, '', 0);	
$pdf->Cell(50, 8, 'Desde:'.$fechaDesdeComision. ' '. 'hasta'. ' ' .$fechaHastaComision.' ' , 0);
$pdf->Ln(23);
...
$productos = mysql_query("SELECT t1.numeroVendedores, t1.nombreVendedores, t2.nombreSucursal, sum(t3.subTotalVenta) as suma, t2.idSucursal, t1.idVendedores,COUNT(t3.idVenta) as ventas from vendedores t1 
			...
			and t3.fechaVenta <= $fechaHastaComision  and t1.idVendedores > $vendedor
...
while($productos2 = mysql_fetch_array($productos)){
	...
	$totalVentas = $totalVentas + $productos2['suma'];
...
$pdf->Ln(8);
$pdf->Cell(114,8,'',0);
$pdf->Cell(31,8,'Comision Total : $ '.number_format($comisionTotal,'2'),2);
