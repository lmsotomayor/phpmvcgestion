...
$productos = mysql_query("SELECT SUM(t1.cantidadVenta) as suma, t1.precioTotal, t2.descripcionProducto, t3.idVenta, COUNT(t3.idVenta) as venta  
	FROM detalleventa t1 INNER JOIN productos t2 ON t1.idProducto = t2.idProducto INNER JOIN venta t3 ON t1.idVenta = t3.idVenta 
